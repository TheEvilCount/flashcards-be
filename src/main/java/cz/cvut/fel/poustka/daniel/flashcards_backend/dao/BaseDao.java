...
import cz.cvut.fel.poustka.daniel.flashcards_backend.exceptions.PersistenceException;
...
public abstract class BaseDao<T> implements GenericDao<T>
{
    ...
    {
        throw new RuntimeException("Delete action is not permitted in this project!");
        /*
        Objects.requireNonNull(entity);
        try {
